...
!(function(e, t) {
    ...
    function u(e, r, a) {
        ...
        return (
            ...
            (("body" !== s(r) || l(u)) &&
                (d =
                    r !== n(r) && i(r) ? { scrollLeft: r.scrollLeft, scrollTop: r.scrollTop } :
                    o(r)),
                i(r) ?
                ...
                var t = e.state,
                    ...
                    r = (e = I.reduce(function(e, n) {
                        ...
                        return (
                            ...
                            (s = ((s = s[1]) || 0) * a),
                            (i =
                                0 <= ["left", "right"].indexOf(i) ? { x: s, y: r } : { x: r, y: s }),
                            (e[n] = i),
                            e
                        );
                    }, {}))[t.placement],
                ...
                if (((s = { x: 0, y: 0 }), a)) {
                    if (r || i) {
                        ...
                        var M = t.modifiersData["arrow#persistent"] ?
                            t.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 };
                        (v = M[v]),
                        (g = M[g]),
                        (m = U(0, z(u[y], m[y]))),
